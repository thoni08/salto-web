export function ThreadCardSkeleton() {
  return (
    <article className="h-56.25 animate-pulse overflow-hidden rounded-2xl border border-(--color-light-blue) bg-white px-6 py-5 shadow-[0_18px_30px_-28px_rgba(37,52,63,0.5)]">
      {/* Badges Skeleton */}
